...
class EncoderDecoder(nn.Module):
    ...
    other models.
    """
    def __init__(self, fuse_encoder, refine_encoder, decoder, src_embed, tgt_embed, generator):
    ...
    def forward(self, grid_0, grid_1, grid_2, grid_3, tgt, tgt_mask):
        ...
        return self.decode(self.refine_encode(self.fuse_encode(grid_0, grid_1, grid_2, grid_3)), tgt, tgt_mask)
...
class FuseEncoder(nn.Module):
    ...
    def __init__(self, swin_model_c):
        ...
        self.swin_model_c = swin_model_c
...
class OSICModel(CaptionModel):
    def make_model(self, src_vocab, tgt_vocab, swin_model_c=96, N=5, DeN=6, d_model=512, s_model=144, d_ff=2048, h_p=8, h_c=4, dropout=0.1):
        ...
        model = EncoderDecoder(FuseEncoder(swin_model_c),
                               RefineEncoder(RefineEncoderLayer(d_model, c(attn), c(ff), dropout), N),
