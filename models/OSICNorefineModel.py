...
class EncoderDecoder(nn.Module):
    ...
    other models.
    """
    def __init__(self, fuse_encoder, decoder, src_embed, tgt_embed, generator):
    ...
    def forward(self, grid_0, grid_1, grid_2, grid_3, tgt, tgt_mask):
        ...
        return self.decode(self.fuse_encode(grid_0, grid_1, grid_2, grid_3), tgt, tgt_mask)

    def fuse_encode(self, x_0, x_1, x_2, x_3):
        return self.src_embed(self.fuse_encoder(x_0, x_1, x_2, x_3))
...
class OSICNorefineModel(CaptionModel):
    def make_model(self, src_vocab, tgt_vocab, swin_model_c=96, N=6, d_model=512, d_ff=2048, h=8, dropout=0.1):
        ...
        model = EncoderDecoder(FuseEncoder(swin_model_c),
    ...
    def __init__(self, opt):
        super(OSICNorefineModel, self).__init__()
        self.opt = opt
    ...
    def _sample_beam(self, x_0, x_1, x_2, x_3, opt={}):
        ...
        memory = self.model.fuse_encode(x_0, x_1, x_2, x_3)
    ...
    def _sample(self, x_0, x_1, x_2, x_3, opt={}):
        ...
        state = None
        # memory = self.model.encode(x_0, x_1, x_2, x_3, seq, seq_masks)
        memory = self.model.fuse_encode(x_0, x_1, x_2, x_3)
