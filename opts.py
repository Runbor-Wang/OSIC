...
def parse_opt():
    ...
    parser.add_argument('--input_images', type=str, default='./Dataset/MS_COCO/MS_COCO_384',
                        help='path to the directory containing the images')
    parser.add_argument('--input_label_h5', type=str,
                        default='./Dataset/MS_COCO/cocotalk_label.h5',
                        help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--cached_tokens', type=str,
                        default='./Dataset/MS_COCO/coco-train-idxs.p',
    ...
    # Model settings
    parser.add_argument('--caption_model', type=str, default="osic",
                        help='transformer, osic_wodmse_worefine, osic_worefine, osic_wodmse, osic')
    ...
    parser.add_argument('--max_sentence_length', type=int, default=16, help='max number words of sentence')
    ...
    parser.add_argument('--learning_rate_decay_start', type=int, default=8,
    ...
    parser.add_argument('--val_images_use', type=int, default=5,
    ...
    parser.add_argument('--checkpoint_path', type=str, default='./OSIC/save_shishi/4e-4/xe',
